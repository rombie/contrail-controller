...
// separate messages.
TEST_F(ConfigJsonParserTest, ServerParser5InParts) {
    IFMapTable *vrtable = IFMapTable::FindTable(&db_, "virtual-router");
    EXPECT_EQ(0, vrtable->Size());
    IFMapTable *vmtable = IFMapTable::FindTable(&db_, "virtual-machine");
    EXPECT_EQ(0, vmtable->Size());
...
TEST_F(ConfigJsonParserTest, ServerParser8) {
    IFMapTable *vrtable = IFMapTable::FindTable(&db_, "virtual-router");
    EXPECT_EQ(0, vrtable->Size());
    IFMapTable *vmtable = IFMapTable::FindTable(&db_, "virtual-machine");
    EXPECT_EQ(0, vmtable->Size());
...
// separate messages.
TEST_F(ConfigJsonParserTest, ServerParser8InParts) {
    IFMapTable *vrtable = IFMapTable::FindTable(&db_, "virtual-router");
    EXPECT_EQ(0, vrtable->Size());
    IFMapTable *vmtable = IFMapTable::FindTable(&db_, "virtual-machine");
    EXPECT_EQ(0, vmtable->Size());
...
// 1) create link(vr,vm), then link(vr,gsc)
// 2) delete link(vr,vm), then link(vr,gsc)
TEST_F(ConfigJsonParserTest, ServerParser12InParts) {
    IFMapTable *vrtable = IFMapTable::FindTable(&db_, "virtual-router");
    EXPECT_EQ(0, vrtable->Size());
    IFMapTable *vmtable = IFMapTable::FindTable(&db_, "virtual-machine");
    EXPECT_EQ(0, vmtable->Size());
...
TEST_F(ConfigJsonParserTest, ServerParser13InParts) {
    IFMapTable *vrtable = IFMapTable::FindTable(&db_, "virtual-router");
    EXPECT_EQ(0, vrtable->Size());
    IFMapTable *vmtable = IFMapTable::FindTable(&db_, "virtual-machine");
    EXPECT_EQ(0, vmtable->Size());
