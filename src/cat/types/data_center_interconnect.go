...
type DataCenterInterconnect struct {
        contrail.ObjectBase
	data_center_interconnect_bgp_hold_time string
	data_center_interconnect_mode string
	data_center_interconnect_bgp_address_families string
...
func (obj *DataCenterInterconnect) GetDataCenterInterconnectBgpHoldTime() string {
        return obj.data_center_interconnect_bgp_hold_time
}

func (obj *DataCenterInterconnect) SetDataCenterInterconnectBgpHoldTime(value string) {
...
func (obj *DataCenterInterconnect) GetDataCenterInterconnectBgpAddressFamilies() string {
        return obj.data_center_interconnect_bgp_address_families
}

func (obj *DataCenterInterconnect) SetDataCenterInterconnectBgpAddressFamilies(value string) {
